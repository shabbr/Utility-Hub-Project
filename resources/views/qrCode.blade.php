        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-primary">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('generateQrCode') }}" method="post">
                    ...
                    <button type="submit"  class="btn btn-primary mx-auto d-block loading-link">Generate QR Code</button>
                </form>
        ...
        $('#loadButton').click(function (e) {
            ...
            $("#results").show();
                    ...
                    <div id="results" style="display: none">
                        <h2>Scan the QR Code to access the URL</h2>
                        <div  class="text-center mt-3"> {!! $qrCode !!} </div>
                        <a href="{{ route('download',['url'=>$filename]) }}" class="btn btn-primary mt-4 mx-auto d-block">
                            Download QR Code
                        </a>
                    @endif
                    </div>
